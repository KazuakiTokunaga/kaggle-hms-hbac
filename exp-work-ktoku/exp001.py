...
class Runner():
    ...
    def load_dataset(self, ):
        ...
        if RCFG.ADD_EXTERNAL_DATA:
            ...
            # otherが多すぎるので減らす
            exclude_cond1 = (ext_data['other_vote']>0.75) & ((ext_data['eeg_id'] // 100) % 5 != 0)
            exclude_cond2 = (ext_data['other_vote']>0.4) & (ext_data['other_vote']<=0.75) & ((ext_data['eeg_id'] // 100) % 3 != 0)
            ext_data = ext_data[~exclude_cond1]
            ext_data = ext_data[~exclude_cond2].reset_index()
